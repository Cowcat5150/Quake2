...
#define OPENGLNOLRU_MENU 2

static menuframework_s	s_software_menu;
static menuframework_s	s_opengl_menu;
static menuframework_s	s_openglnolru_menu;
...
static void DriverCallback( void *unused )
{
	if ( s_ref_list[s_current_menu_index].curvalue == 0 )
	{
		...
		s_ref_list[2].curvalue = 1;
	}

	else if (s_ref_list[s_current_menu_index].curvalue == 1)
	{
		s_current_menu = &s_opengl_menu;
		s_current_menu_index = 1;
		s_ref_list[0].curvalue = 0;
		s_ref_list[1].curvalue = 1;
		s_ref_list[2].curvalue = 2;
	}

	else
	{
		s_current_menu = &s_openglnolru_menu;
		s_current_menu_index = 2;
		s_ref_list[0].curvalue = 2;
		s_ref_list[1].curvalue = 1;
		s_ref_list[2].curvalue = 2;
	}
}
...
static void BrightnessCallback( void *s )
{
	...
	else s_brightness_slider[2].curvalue = s_brightness_slider[2].curvalue;
...
static void ApplyChanges( void *unused )
{
	...
	*/
	...
	if ( s_ref_list[s_current_menu_index].curvalue == 0 )
	{
		...
		s_ref_list[1].curvalue = 0;
		s_ref_list[2].curvalue = 1;
		s_fs_box[1].curvalue = s_fs_box[s_current_menu_index].curvalue;
		s_fs_box[2].curvalue = s_fs_box[s_current_menu_index].curvalue;
		s_brightness_slider[1].curvalue = s_brightness_slider[s_current_menu_index].curvalue;
		s_brightness_slider[2].curvalue = s_brightness_slider[s_current_menu_index].curvalue;
	}
	...
	else if (s_ref_list[s_current_menu_index].curvalue == 1)
	{
		...
		s_ref_list[1].curvalue = 1;
		s_ref_list[2].curvalue = 2;
		s_fs_box[0].curvalue = s_fs_box[s_current_menu_index].curvalue;
		s_fs_box[2].curvalue = s_fs_box[s_current_menu_index].curvalue;
		s_brightness_slider[0].curvalue = s_brightness_slider[s_current_menu_index].curvalue;
		s_brightness_slider[2].curvalue = s_brightness_slider[s_current_menu_index].curvalue;
	}
	...
	*/
	...
	if (s_ref_list[s_current_menu_index].curvalue==REF_OPENGL)
		...
		Cvar_SetValue("gl_mode", s_mode_list[2].curvalue);
	...
	*/
	...
	if (( strcmp( vid_ref->string, "gl" ) == 0 )|| (strcmp(vid_ref->string,"glnolru") == 0))
	{
...
DLLFUNC void VID_MenuInit( void )
{	
	static const char *resolutions[] = 
	{
		...
		"[512 288 WS]", // widescreen modes - Cowcat
		"[640 360 WS]",
		"[768 432 WS]",
		"[848 480 WS]",
		"[960 540 WS]",
	...
	s_mode_list[2].curvalue = gl_mode->value;
	...
	s_screensize_slider[2].curvalue = scr_viewsize->value/10;
	...
	{
		s_current_menu_index = 2;
		s_ref_list[s_current_menu_index].curvalue = 2;
		s_ref_list[0].curvalue=0;
		s_ref_list[1].curvalue=1;
	}
	...
	s_openglnolru_menu.x = viddef.width * 0.50;
	s_openglnolru_menu.nitems = 0;
	...
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_ref_list[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_mode_list[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_screensize_slider[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_brightness_slider[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_fs_box[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_tq_slider );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_paletted_texture_box );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_finish_box );
	...
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_defaults_action[OPENGLNOLRU_MENU] );
	Menu_AddItem( &s_openglnolru_menu, ( void * ) &s_cancel_action[OPENGLNOLRU_MENU] );

	Menu_Center( &s_software_menu );
	Menu_Center( &s_opengl_menu );
	Menu_Center( &s_openglnolru_menu);
	s_opengl_menu.x -= 8;
	s_openglnolru_menu.x -= 8;
	s_software_menu.x -= 8;
...
void VID_MenuDraw (void)
{
	...
	else if (s_current_menu_index == 1)
		s_current_menu = &s_opengl_menu;
