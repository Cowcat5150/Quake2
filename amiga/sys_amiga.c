...
extern getcwd(char *, size_t);
extern void Key_Event();
extern void IN_GetMouseMove();
extern int MapKey();
		...
		switch(imsg->Class)
		{
			case IDCMP_RAWKEY:
				...
				if ((0x7F & imsg->Code) == 122 || (0x7F & imsg->Code) == 123)
				{
					...
					{
						case 0x7A:
							Key_Event(K_MWHEELUP, true, sys_msg_time, -1);
							break;
						...
						case 0x7B:
							Key_Event(K_MWHEELDOWN, true, sys_msg_time, -1);
							break;
