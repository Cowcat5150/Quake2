...
void RunEntity (edict_t *ent);    // ?? saveds ?
...
{	
	...
	globals.Init = InitGame;		//  g_save.c
	globals.Shutdown = ShutdownGame;	//  g_main.c  
	globals.SpawnEntities = SpawnEntities;  //  g_spawn.c

	globals.WriteGame = WriteGame;		//  g_save.c
	globals.ReadGame = ReadGame;		//     "
	globals.WriteLevel = WriteLevel; 	//     "
	globals.ReadLevel = ReadLevel;		//     "

	globals.ClientThink = ClientThink;	// p_client.c
	globals.ClientConnect = ClientConnect;  // p_client.c
	globals.ClientUserinfoChanged = ClientUserinfoChanged; // p_client.c
	globals.ClientDisconnect = ClientDisconnect;	       //    "	
	globals.ClientBegin = ClientBegin;		       //    "
	globals.ClientCommand = ClientCommand;  // g_cmds.c

	globals.RunFrame = G_RunFrame; 		// g_main.c

	globals.ServerCommand = ServerCommand;  // g_svcmds.c
