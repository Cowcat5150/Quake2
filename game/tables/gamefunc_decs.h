...
extern DLLFUNC void ReadLevel ( const char * filename ) ;
extern void ReadLevelLocals ( FILE * f ) ;
extern void ReadEdict ( FILE * f , edict_t * ent ) ;
extern DLLFUNC void WriteLevel ( const char * filename ) ;
extern void WriteLevelLocals ( FILE * f ) ;
extern void WriteEdict ( FILE * f , edict_t * ent ) ;
extern DLLFUNC void ReadGame ( const char * filename ) ;
extern DLLFUNC void WriteGame ( const char * filename , qboolean autosave ) ;
...
extern DLLFUNC void InitGame ( void ) ;
...
//extern int Q_strlcat ( char * dst , const char * src , int size ) ; // Cowcat
//extern int Q_strlcpy ( char * dst , const char * src , int size ) ; // Cowcat
extern char *strlwr ( char * s ) ; // Cowcat
...
//extern int Q_stricmp ( const char * s1 , const char * s2 ) ; // Cowcat
...
extern void COM_DefaultExtension ( char * path , char * extension ) ; // was const char *ext
extern void COM_FilePath ( char * in , char * out ) ; // was const char *in
...
//extern int BoxOnPlaneSide2 ( vec3_t emins , vec3_t emaxs , struct cplane_s * p ) ; // Cowcat
...
//extern void AngleVectors2 ( vec3_t value1 , vec3_t angles ) ; // Cowcat
...
//extern void InventoryMessage ( edict_t * ent ) ; // Cowcat
...
//extern void SP_CreateUnnamedSpawn ( edict_t * self ) ; // Cowcat
...
extern DLLFUNC void ServerCommand ( void ) ;
...
//extern void misc_blackhole_transparent ( edict_t * ent ) ; // Cowcat
