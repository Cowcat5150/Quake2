...
{"goal_hint", FOFSMO(monsterinfo,goal_hint), F_EDICT},
{"badMedic1", FOFSMO(monsterinfo,badMedic1), F_EDICT},
{"badMedic2", FOFSMO(monsterinfo,badMedic2), F_EDICT},
{"last_player_enemy", FOFSMO(monsterinfo,last_player_enemy), F_EDICT},
{"commander", FOFSMO(monsterinfo,commander), F_EDICT},
{"blocked", FOFSMO(monsterinfo,blocked), F_FUNCTION, FFL_NOSPAWN},
{"duck", FOFSMO(monsterinfo,duck), F_FUNCTION, FFL_NOSPAWN},
{"unduck", FOFSMO(monsterinfo,unduck), F_FUNCTION, FFL_NOSPAWN},
{"sidestep", FOFSMO(monsterinfo,sidestep), F_FUNCTION, FFL_NOSPAWN},
