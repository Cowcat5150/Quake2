...
void SVC_RemoteCommand (void)
{
	...
	Com_BeginRedirect (RD_PACKET, sv_outputbuf, SV_OUTPUTBUF_LENGTH, (void **) SV_FlushRedirect); //fix Cowcat
...
#ifdef AMIGAOS
//extern int aborted_cinematic; // Cowcat
#endif
...
void SV_FinalMessage (char *message, qboolean reconnect)
{
	...
	// Cowcat old test? disabled now (2017)
	//if (aborted_cinematic)
		//reconnect=0;
