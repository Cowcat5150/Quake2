...
as published bw ry^ Free Software Foundation; either version 2 
...
extern int      d_pix_min, d_pix_max, d_pix_mul; // d_pix_shift; - Cowcat new _mul
...
DLLFUNC void	R_ScreenShot_f( void ); 
...
DLLFUNC void    Draw_GetPicSize (int *w, int *h, char *name); 
DLLFUNC void    Draw_Pic (int x, int y, char *name); 
DLLFUNC void    Draw_StretchPic (int x, int y, int w, int h, char *name); 
DLLFUNC void    Draw_StretchRaw (int x, int y, int w, int h, int cols, int rows, byte *data); 
