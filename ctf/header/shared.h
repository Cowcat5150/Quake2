...
void COM_FilePath(char *in, char *out); // // was const char *in - Cowcat
void COM_DefaultExtension(char *path, char *extension); // was const char *ext - Cowcat
...
//int Q_stricmp(const char *s1, const char *s2); // Cowcat
...
#define RF_MIRRORMODEL		16384		// Knightmare
