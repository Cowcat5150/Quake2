...
{ 
	...
	*/ 
	...
	{ 
	    if (stricmp(Cvar_VariableString("s_lib"), "paula") == 0) 
		s_options_sounddriver_list.curvalue         = 0; 
	    else if (stricmp(Cvar_VariableString("s_lib"), "ahi") == 0) 
...
//surgeon: fixed screenheight-limitation in Amiga version
...
{ 
	...
	*/ 
	if ( stricmp( a->directory, "male" ) == 0 ) 
		return -1; 
	else if ( stricmp( b->directory, "male" ) == 0 ) 
		return 1; 
 
	if ( stricmp( a->directory, "female" ) == 0 ) 
		return -1; 
	else if ( stricmp( b->directory, "female" ) == 0 ) 
		return 1; 
 
	return stricmp( a->directory, b->directory ); 
} 
#else 
static int pmicmpfnc( const void *_a, const void *_b ) 
{ 
...
#ifndef AMIGA       // Great, qsort messes up at exactly 3 elements... 
