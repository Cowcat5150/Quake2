...
float CalcFov (float fov_x, int width, int height) // problems compiling for 68k ? Cowcat
{
	static float	a;
...
#endif
{
	...
	//float f; // Barnes added Q3 water warp
